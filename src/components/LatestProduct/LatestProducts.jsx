...
import LatestProductsSlider from '../ProductsSlider/LatestProductsSlider';
...
const LatestProducts = () => {
  ...
  <div className="leftsec">
    ...
    <div className="h-[2px] w-16 md:w-20 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-rose-500 rounded-full mb-2"></div>
    ...
    <div className="hidden md:block">
      <Box sx={{ bgcolor: 'transparent' }}>
        <Tabs
          ...
          aria-label="latest products tabs"
          sx={{
            minHeight: 0,
            ...
            '& .Mui-selected': {
              color: '#6d28d9',
              background:
                'linear-gradient(135deg, rgba(124,58,237,0.18), rgba(244,63,94,0.18))',
        ...
        {filteredProducts.length > 0 ? (
          <LatestProductsSlider products={filteredProducts} />
        ) : (
