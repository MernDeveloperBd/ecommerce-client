    ...
    return (
        <div className="qtyBox flex items-center relative">
            ...
            <div className="flex items-center flex-col justify-between h-[38px] absolute top-0 right-0 z-50">
                <Button onClick={plusQty} className="!min-w-[30px] !w-[20px] !h-[15px] !text-[13px] !text-black !mt-0.5"><FaAngleUp/></Button>
                <Button onClick={minusQty} className="!min-w-[30px] !w-[20px] !h-[15px] !text-[13px] !text-black !mb-0.5"><FaAngleDown/></Button>
            </div>
        </div>
    );
};
