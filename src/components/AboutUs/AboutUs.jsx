...
import useravater from '../../assets/user_avater.png'
...
const AboutUs = () => {
  ...
  return (
    <div className="overflow-x-hidden my-2">
      <SEO 
        title="About Us | MM Fashion World"
        description="Know the story behind MM Fashion World – a brand rooted in love, tradition, and women empowerment. Discover our mission, vision, and handcrafted fashion."
        canonical="/about-us"
        type="website"
      />
      ...
      >
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-green-800 mb-6">
            স্বাগতম MM Fashion World-এ!
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed">
            <span className="font-semibold text-[#c3192a]">MM Fashion World</span>-এর যাত্রা শুরু হয়েছে 
            ফ্যাশনের প্রতি ভালোবাসা এবং নারীদের আত্মনির্ভরশীলতা গড়ে তোলার এক নিঃস্বার্থ প্রচেষ্টাকে কেন্দ্র করে। 
            মিসাম ও মারিফা—এই দুই নামের পেছনে রয়েছে আমাদের বিশ্বাস, স্বপ্ন এবং সৃজনশীলতার এক অপার গল্প।
          </p>
        </div>
      </motion.section>
      ...
      <section className="bg-gray-50 py-6 md:py-12">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            >
              <img
                src="https://res.cloudinary.com/dqokqca8p/image/upload/v1756018288/My%20Brand/Misam_Marifa_Fashion_World_jkz3o8.png"
            ...
            >
              ...
              <p className="text-gray-700 mb-4 leading-relaxed">
                আমাদের পণ্যের প্রতিটি ডিজাইনে থাকে ভালোবাসা, যত্ন এবং শিল্প। দেশীয় হস্তশিল্প, 
                আধুনিক স্টাইল এবং মানসম্পন্ন উপকরণের মিশ্রণে আমরা তৈরি করি এমন পোশাক যা 
                আপনাকে শুধু সুন্দরই নয়, স্বাচ্ছন্দ্যও দেবে।
              </p>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-green-700">আমাদের লক্ষ্য</h3>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-2">
                    <span className="text-[#c3192a] mt-1">✓</span>
                    দেশীয় ফ্যাশনকে বিশ্ব দরবারে তুলে ধরা
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#c3192a] mt-1">✓</span>
                    নারীদের জন্য নিজস্ব পরিচয়ের একটি প্ল্যাটফর্ম তৈরি করা
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-[#c3192a] mt-1">✓</span>
                    গুণগতমান এবং কাস্টমার সন্তুষ্টির সর্বোচ্চ গুরুত্ব দেওয়া
                  </li>
                </ul>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-2xl font-bold mb-4 text-green-700">আমাদের আনন্দ</h3>
                <p className="text-gray-700 leading-relaxed">
                  আমরা শুধু পোশাক বিক্রি করি না, আমরা আত্মবিশ্বাস, রুচিশীলতা এবং নারীর সৃজনশীল 
                  শক্তিকে উদযাপন করি। আপনি আমাদের ওয়েবসাইটে যা দেখবেন, তার প্রতিটিতেই থাকবে 
                  একটি করে গল্প—আপনার মতোই এক অজানা গল্প।
                </p>
              </div>
            </div>
          </motion.div>
          ...
          {youtubeVideoId ? (
            ...
            <div className="bg-gray-100 rounded-lg p-8 text-center">
              <p className="text-gray-600">
                ভিডিও যোগ করার জন্য YouTube video ID প্রদান করুন (youtubeVideoId)।
              </p>
            </div>
          )}
        </div>
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-6 opacity-90">
            যোগাযোগ করুন, আমাদের সঙ্গে যুক্ত হোন, এবং <span className="font-bold text-pink-800">MM Fashion World</span> -এর যাত্রায় সঙ্গী হোন।
          </p>
          ...
          <Link to="/productListing">
            <button className="inline-flex items-center gap-2 bg-[#108ac7] text-white px-4 py-3 rounded-full shadow hover:bg-[#0372aa] transition">
              Shop Now
            </button>
          </Link>
          ...
          >
            <FaWhatsapp />
            <span className="hidden sm:inline">WhatsApp এ যোগাযোগ করুন</span>
          </a>
        </div>
        </div>
      </motion.section>
