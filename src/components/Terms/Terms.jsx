...
export default function Terms({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        <SEO
        title="Terms & Conditions | MM Fashion World"
      ...
      {/* Header */}
      <motion.header 
        className="bg-gradient-to-r from-[#c3192a] via-[#a01322] to-[#8B1538] text-white shadow-2xl"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
          ...
          {sections.map((section, idx) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <motion.div
                  initial={false}
                  animate={{ height: expandedSections[idx] ? 'auto' : 0 }}
        ...
        <motion.div 
          className="mt-12 bg-gradient-to-r from-[#c3192a] to-[#8B1538] rounded-2xl shadow-xl text-white p-8"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
